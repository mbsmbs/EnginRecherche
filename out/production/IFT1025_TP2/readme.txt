...
afficher les résultats de rechercher en montrant les fréquences d'occurrence des mots dans chaque document sur l’interface graphique.
...
- Menu « Indexer » :
	...
	- « Inverser » qui crée une structure d'index des mots.

- Menu « Afficher » :
	- « Liste de document » qui affiche la liste des documents choisis avec les informations de ses mots.
	- « Liste de mots » qui affiche liste de tous les mots qui existent dans les documents choisis. 

- Menu « Rechercher » : 
	- « Mot » qui permet à l'utilisateur d'entrer les mots à rechercher et affiche les résultats trouvés.

Voici les détails pour la structure de notre programme :

Notre programme est composé par « Modèle » « Contrôle » et « Vue ».

- « Vue »      : Gestion de tous les affichages d'interface graphique.

- « Modele »   : Gestion des données.
...
Mode d'utilisation :
    ...
    5. Vous pouvez enfin entrer les mots à rechercher en cliquant sur le menu